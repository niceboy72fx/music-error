...
// const musicImg = $(".wrapper .img-area img");
// const musicName = $(".wrapper .song-detail .name");
// const musicArtist = $(".wrapper.song-detail .artist");
// const playPauseBtn = $(".play-pause");
// const prevBtn = $(".wrapper #prev");
// const nextBtn = $(".wrapper #next");
// const mainAudio = $(".wrapper #main-audio");
// const progressArea = $(".wrapper .progress-area");
// const progressBar = $(".wrapper .progress-area .progress-bar");
// const musicList = $(".wrapper .music-list");
// const moreMusicBtn = $(".wrapper #more-music");
// const closemoreMusic = $(".wrapper .music-list #close");
// const repeatBtn = $(".wrapper #repeat-plist");
...
const getMusic = (indexNumb) => {
  ...
  musicImg.src = `img/${allMusic[indexNumb - 1].src}.jpg`; // lay du lieu anh
  mainAudio.src = `song/${allMusic[indexNumb - 1].src}.mp3`; // lay du lieu list nhac
};
...
for (let i = 0; i < allMusic.length; ++i) {             // tao 1 the li the hien cac list nhac
  ...
  liAudioTag.addEventListener("loadeddata", () => {
    ...
    liAudioDuartionTag.setAttribute("t-duration", `${totalMin}:${totalSec}`); // tao 1 atribute class t-duration
  });
}
